...
<%
	...
	// multipart/form-data로 보낸 문자열은
	// request객체가 해석할 수 없습니다
	// cos에 있는 MultipartRequest라는 객체를 사용해야 합니다
//	String name = request.getParameter("name");
	// Multipart로 넘어온 파라메타를 해석하기 위해 MultipartRequest라는 객체를 생성한다
	// 업로드 파일의 최대 크기
...
<html>
	...
	<body>
		name : <%= name %><br>
		<a href="view.jsp?phyName=<%= phyName %>&logiName=<%= logiName %>">이미지 확인하기</a>
	</body>
</html>